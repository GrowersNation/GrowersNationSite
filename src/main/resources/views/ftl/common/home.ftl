...
<#include "../includes/common/header.ftl">
  ...
  <p><a href="/api/private/home">Access private info (protected with OpenId) available to public</a>
  <p><a href="/api/private/admin">Access private info (protected with OpenId) available to Administrators</a>
