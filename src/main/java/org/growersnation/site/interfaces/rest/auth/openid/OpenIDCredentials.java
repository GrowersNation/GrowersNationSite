...
public class OpenIDCredentials {
   ...
   * @param requiredAuthorities The authorities required to authenticate (provided by the {@link org.growersnation.site.interfaces.rest.auth.annotation.RestrictedTo} annotation)
   */
