package org.growersnation.site.infrastructure.dto.thirdparty.sensor;

import com.fasterxml.jackson.annotation.JsonProperty;

/**
 * <p>DTO to provide the following to sensor API:</p>
 * <ul>
 * <li>Provision of sensor data gathered from an external source (e.g. an Arduino sensor array)</li>
 * </ul>
 *
 * @since 0.0.1
 *         
